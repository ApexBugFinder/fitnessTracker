...
@Component({
  selector: 'app-a1-react-form',
  templateUrl: './a1-react-form.component.html',
  styleUrls: ['./a1-react-form.component.css']
})
export class A1ReactFormComponent implements OnInit {
